...
Short description: Landing page and navigation hub for the dashboard.

### Category Analysis
![Category 1](images/category_1.png)  
Short description: Revenue contribution, cumulative concentration, and SKU structure by category.

### Category Deep Dive I
![Category 2](images/category_2.png)  
Short description: Price bands, category performance, and multi-metric comparison.

### Category Deep Dive II
![Category 3](images/category_3.png)  
Short description: Monthly category trends, shipping preferences, weekend behavior, and cancellation breakdown.

### Product Analysis
![Product 1](images/product_1.png)  
Short description: Product quantity, revenue, profit, loss, and monthly trend analysis.

### Product Diagnostics I
![Product 2](images/product_2.png)  
Short description: Regional mapping, SKU/category relationship, and top SKU revenue view.

### Product Diagnostics II
![Product 3](images/product_3.png)  
Short description: SKU-level diagnostics with action flags, issue indicators, and cancellation breakdown.

### Buy Box Analysis
![Buy Box 1](images/buybox_1.png)  
Short description: Buy Box proxy KPIs, category comparisons, and competitiveness distribution.

### Buy Box Deep Dive
![Buy Box 2](images/buybox_2.png)  
Short description: Delay, cancellation, revenue, and monthly Buy Box product analysis.

### Private Label Analysis
![Private Label 1](images/private_label_1.png)  
Short description: Private label revenue comparison and product-level labeled analysis.

### Private Label Deep Dive
![Private Label 2](images/private_label_2.png)  
Short description: Quantity, Buy Box score components, and product-level private label diagnostics.

### A/B Test
![AB Test](images/ab_test.png)  
Short description: Group-based comparisons for promotion, service level, and private label setups.

### Effect Size Analysis
![Effect Size 1](images/effect_size_1.png)  
Short description: Composite effect size proxy, estimated gain scenarios, and impact by category.

### Effect Size Cancellation View
![Effect Size 2](images/effect_size_2.png)  
Short description: Cancellation-linked effect size interpretation, recovery potential, and category-level impact.
